import { WorkflowDefinition, RetryPolicy } from '../types/index.js';

/**
 * 工作流DSL定义接口
 */
export class WorkflowDSL {
  static createWorkflow(definition: Partial<WorkflowDefinition>): WorkflowDefinition {
    return {
      ...
      global: {
        ...
        retryPolicy: definition.global?.retryPolicy || { maxRetries: 3, delay: 1000 },
